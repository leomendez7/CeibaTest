...
extension UIView {
    ...
    public func insertSubview(_ view: UIView, atIndex index: NSInteger,
        ...
        setLayoutConstraints(view, contentMode: contentMode, keyboardAware: keyboardAware)
    }
    ...
    public func setLayoutConstraints(_ view: UIView, contentMode: BaseViewContentMode, keyboardAware: Bool = false) {
